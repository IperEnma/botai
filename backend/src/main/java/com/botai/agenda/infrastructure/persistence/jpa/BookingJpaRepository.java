...
import com.botai.agenda.infrastructure.persistence.entity.BookingEntity;
...
public interface BookingJpaRepository extends JpaRepository<BookingEntity, UUID> {
    ...
    @Query("""
            ...
            where b.businessId = :businessId
              ...
              and b.estado in (com.botai.agenda.domain.model.BookingEstado.PENDING,
                               com.botai.agenda.domain.model.BookingEstado.CONFIRMED)
    ...
    @Query("""
            ...
            where b.userId = :userId
              ...
              and b.estado in (com.botai.agenda.domain.model.BookingEstado.CONFIRMED,
                               com.botai.agenda.domain.model.BookingEstado.COMPLETED)
