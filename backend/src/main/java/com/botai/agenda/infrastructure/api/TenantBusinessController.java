...
public class TenantBusinessController {
    ...
    public ResponseEntity<BusinessResponse> create(@PathVariable("tenantId") String tenantId,
    ...
    public BusinessResponse update(@PathVariable("tenantId") String tenantId,
    ...
    public ResponseEntity<Void> associateCategories(@PathVariable("tenantId") String tenantId,
                                                    @PathVariable("businessId") UUID businessId,
    ...
    public List<BusinessResponse> list(@PathVariable("tenantId") String tenantId) {
    ...
    public BusinessResponse detail(@PathVariable("tenantId") String tenantId,
                                   @PathVariable("businessId") UUID businessId) {
