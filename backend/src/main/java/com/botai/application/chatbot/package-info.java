 ...
 *   <li>{@code prompt} — textos del LLM y tools centralizados ({@link com.botai.application.chatbot.prompt.BotPrompts}).</li>
 *   <li>{@code support} — utilidades sin estado ({@link com.botai.application.chatbot.support.InboundMetadata}, respuestas estándar).</li>
 *   <li>{@code usecase} — fachadas de entrada (p. ej. procesar mensaje entrante).</li>
 * </ul>
 */
package com.botai.application.chatbot;
