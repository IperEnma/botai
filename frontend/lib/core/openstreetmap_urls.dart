...
abstract final class OpenStreetMapUrls {
  ...
  /// Abre la búsqueda de la dirección en openstreetmap.org.
  static String search(String address) {
    final q = Uri.encodeComponent(address.trim());
    return 'https://www.openstreetmap.org/search?query=$q';
  }

  /// Geocodifica con Nominatim (gratis; respetar uso moderado, resultado cacheado).
  ...
  /// Miniatura estática vía staticmap.openstreetmap.de (sin API key).
  static String staticMapThumbnail({
    required double lat,
    required double lon,
    int size = 192,
  }) {
